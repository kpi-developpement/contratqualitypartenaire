        ...
        <div className={cn("transition-opacity duration-300", viewMode === 'bonus' ? "opacity-100 block" : "opacity-0 hidden")}>
          <table className="w-full text-sm text-left border-collapse min-w-[1100px]">
            ...
            <tbody className="bg-white">
                ...
                return (
                  <tr key={`bonus-${row.id}`} className="hover:bg-slate-50/60 transition-colors border-b border-slate-100/60 group">
                    ...
                    <td className="py-3 px-6 text-center border-r border-slate-100 bg-white">
                      <div className="inline-flex items-center justify-center bg-slate-50 border border-slate-200/80 rounded-lg px-2 py-1 focus-within:ring-2 focus-within:ring-purple-500/20 focus-within:border-purple-400">
              ...
              {(filterMode === 'ALL' || filterMode === 'AUTRES') && otherIndicatorsDef.map((row) => {
                ...
                return (
                  <tr key={`bonus-other-${row.id}`} className="hover:bg-slate-50/60 transition-colors border-b border-slate-100/60 bg-[#fbfcfd]">
                    ...
                    <td className="py-3 px-6 text-center border-r border-slate-100"><span className="font-black text-slate-800 text-[14px]">{formatPercent(resultat)}</span></td>
                    ...
                    <td className="py-3 px-6 text-center border-r border-slate-100">
                      <div className="inline-flex items-center justify-center bg-white border border-slate-200/80 rounded-lg px-2 py-1 focus-within:ring-2 focus-within:border-purple-400 shadow-sm">
                        <input type="number" step="0.01" value={targets[row.id].min} onChange={(e) => handleTargetChange(row.id, 'min', e.target.value)} className="w-12 bg-transparent text-right outline-none font-bold text-slate-700 text-[13px]" /><span className="text-slate-400 font-bold text-[10px] ml-0.5">%</span>
                      </div>
                    </td>
                    <td className="py-3 px-6 text-center border-r border-slate-100">
                    ...
                    <td className="py-3 px-6 text-center border-r border-slate-100">
                      <div className="inline-flex items-center justify-center bg-white border border-slate-200/80 rounded-lg px-2 py-1 focus-within:ring-2 focus-within:border-rose-400 shadow-sm">
                    ...
                    <td className="py-3 px-6 text-center border-r border-slate-100">
                      <div className="inline-flex items-center justify-center bg-white border border-slate-200/80 rounded-lg px-2 py-1 focus-within:ring-2 focus-within:border-emerald-400 shadow-sm">
              ...
              {/* TOTAL BONUS FOOTER */}
              <tr className="bg-emerald-100/50 border-t-2 border-emerald-200/80">
                ...
                <td className="py-5 px-6 text-center">
                  <div className={cn("inline-flex items-center justify-center px-5 py-2.5 rounded-xl font-black text-[17px] shadow-md border", totalBonus >= 0 ? "bg-emerald-500 text-white border-emerald-600" : "bg-rose-500 text-white border-rose-600")}>
